...
class Question_Answer:
    ...
    def __init__(self, problems,correct_answers):         #correct_answers
        self.problems = problems    # hint               self 추가
        self.correct_answers = correct_answers     # hint       self 추가
    ...
    def problems_main(self):
        ...
        for question in range(4):    # hint    --------------------------------   add 4
...
if __name__ == "__main__":
    ...
    question_answer = Question_Answer(list_problems,list_corrects)    # hint list_corrects 추가
